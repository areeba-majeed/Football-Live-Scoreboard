            ...
            {leagues.length > 1 && (
                <div className="flex gap-3 overflow-x-auto pb-3 pt-1 scrollbar-none" style={{ scrollbarWidth: "none" }}>
                    <button
                        ...
                        className={`flex-shrink-0 rounded-full px-5 py-2.5 text-sm font-extrabold transition-all duration-300 ease-out cursor-pointer hover:-translate-y-0.5 active:scale-95 min-w-[140px] text-center ${selectedLeague === "all"
                    ...
                    {leagues.map((l) => (
                        <button
                            ...
                            className={`flex flex-shrink-0 items-center justify-center gap-2 rounded-full px-5 py-2.5 text-sm font-extrabold transition-all duration-300 ease-out cursor-pointer hover:-translate-y-0.5 active:scale-95 min-w-[140px] ${selectedLeague === String(l.id)
                                    ? "bg-accent text-white shadow-md shadow-accent/25 hover:shadow-lg hover:shadow-accent/35"
                                    : "bg-slate-100/80 hover:bg-slate-200/90 text-slate-650 dark:bg-card-dark dark:text-slate-300 dark:hover:bg-slate-800 border border-slate-200/60 dark:border-slate-800/40 shadow-sm"
                                }`}
                        >
