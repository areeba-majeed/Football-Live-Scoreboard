                    ...
                    {["stats", "timeline"].map((t) => {
                        ...
                        return (
                            <button
                                key={t}
                                onClick={() => setTab(t)}
                                className={`relative z-10 flex-1 rounded-full py-2 text-xs font-black capitalize transition-colors duration-300 cursor-pointer ${isActive
                                        ? "text-accent"
                            ...
                            >
                                ...
                                {t === "timeline" && events.length > 0 && (
                                    <span className={`ml-1.5 rounded-full px-1.5 py-0.5 text-[9px] font-extrabold transition-all duration-300 ${isActive
