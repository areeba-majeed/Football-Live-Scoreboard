                        ...
                        {tabs.map((tab, idx) => {
                            ...
                            return (
                                <Link
                                    key={tab.key}
                                    to={tab.path}
                                    className={`relative z-10 flex flex-1 items-center justify-center gap-1.5 py-1.5 text-xs font-extrabold transition-colors duration-300 ${isActive
                                            ? "text-accent"
                        ...
                        {tabs.map((tab, idx) => {
                            ...
                            return (
                                <Link
                                    key={tab.key}
                                    to={tab.path}
                                    className={`relative z-10 flex flex-1 items-center justify-center gap-1.5 py-2 text-xs font-extrabold transition-colors duration-300 ${isActive
                                            ? "text-accent"
                                            : "text-slate-500 hover:text-slate-800 dark:text-slate-400 dark:hover:text-slate-200"
                                        }`}
                                >
